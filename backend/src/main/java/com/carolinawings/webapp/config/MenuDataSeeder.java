        ...
        return args -> {
            if(repo.count() == 0) {
                List<MenuItem> items = List.of(
                        ...
                        MenuItemFactory.createMenuItem("Mozzarella Sticks", "", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(7.99), "Shareables", true),
                        ...
                        MenuItemFactory.createMenuItem("Certified Jumbo Wings - 18 Wings (up to 2 flavors)", "", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(22.99), "Wings and Tenders", true),
                        MenuItemFactory.createMenuItem("Certified Jumbo Wings - 24 Wings (up to 3 flavors)", "", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(27.99), "Wings and Tenders", true),
                        ...
                        MenuItemFactory.createMenuItem("Boneless Wings - 18 Wings (up to 2 flavors)", "", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(16.99), "Wings and Tenders", true),
                        MenuItemFactory.createMenuItem("Boneless Wings - 24 Wings (up to 3 flavors)", "", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(22.99), "Wings and Tenders", true),
