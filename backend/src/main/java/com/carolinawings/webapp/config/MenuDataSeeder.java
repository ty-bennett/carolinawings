        ...
        return args -> {
            if(repo.count() == 0) {
                List<MenuItem> items = List.of(
                        ...
                        MenuItemFactory.createMenuItem("Ultimate Nachos - Buffalo Chicken", "", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(10.99), "Shareables"),
                        MenuItemFactory.createMenuItem("Ultimate Nachos - Pulled Pork", "", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(10.99), "Shareables"),
                        MenuItemFactory.createMenuItem("Mozzarella Sticks", "", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(7.99), "Shareables"),
                        ...
                        MenuItemFactory.createMenuItem("Fried Mushrooms", "", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(7.99), "Shareables"),
                        ...
                        MenuItemFactory.createMenuItem("Baby Back Ribs - Large Rack", "", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(19.99), "Ribs, BBQ, and Seafood"),
                        ...
                        MenuItemFactory.createMenuItem("Fried Shrimp Plate", "1/2 lb. of our famous hand-battered shrimp fried to a golden brown. Sauce things up by adding your favorite CW flavor for .59", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(13.99), "Ribs, BBQ, and Seafood"),
                        ...
                        MenuItemFactory.createMenuItem("Fried Catfish Plate", "Fresh catfish filets, hand-battered & fried.", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(13.99), "Ribs, BBQ, and Seafood"),
                        ...
                        MenuItemFactory.createMenuItem("Carolina Pig Sauce Burger", "House-pattied burger, slow-roasted BBQ, bacon, onion rings, cheese & smothered in our award-winning Carolina Pig Sauce.", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(13.59), "Burgers"),
                        ...
                        MenuItemFactory.createMenuItem("The Carolina Burger", "With lettuce, tomato & onion (LTO).", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(9.99), "Burgers"),
                        MenuItemFactory.createMenuItem("Monterey Jack or American Cheese", "", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(10.59), "Burgers"),
                        MenuItemFactory.createMenuItem("Cheese & Bacon", "", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(11.99), "Burgers"),
                        ...
                        MenuItemFactory.createMenuItem("Atomic Burger", "Our seasoned burger topped with Monterey Jack cheese, jalapeños and our signature hot sauce & LTO.", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(11.99), "Burgers"),
                        MenuItemFactory.createMenuItem("Mini Sliders", "(3) Mini Sliders w/ Cheese and Pickles", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(9.99), "Burgers"),
                        ...
                        MenuItemFactory.createMenuItem("Ultimate Carolina Chicken", "Fried chicken breast sautéed in your favorite CW's wing sauce. Topped with Monterey Jack cheese, lettuce & tomato.", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(10.99), "Sandwiches and Wraps"),
                        ...
                        MenuItemFactory.createMenuItem("Carolina Club", "Served on toasted wheat berry bread.", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(10.99), "Sandwiches and Wraps"),
                        ...
                        MenuItemFactory.createMenuItem("Veggie Wrap", "Our grilled veggies with parmesan cheese. Served with marinara dip on the side.", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(9.99), "Sandwiches and Wraps"),
                        ...
                        MenuItemFactory.createMenuItem("Tater Tots", "", "https://cdn.carolinawings.com/images/placeholder.jpg", BigDecimal.valueOf(4.59), "Side Items")
                        );
                repo.saveAll(items);
